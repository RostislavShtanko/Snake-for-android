...
public class CanvasButton {
    ...
    public CanvasButton(float x1, float y1, float x2, float y2, String text, int color, int fontSize) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    public void draw() {
        ...
        Game.gameView.drawRect(x1, y1, x2, y2);
        ...
        Game.gameView.drawText(text, x1 + (x2 - x1) / 2 - (textWidth / 2f), y1 + (y2 - y1) / 2 + (textHeight / 2f));
    }
